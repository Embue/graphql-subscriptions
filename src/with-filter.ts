...
export type AsyncResolverFn<TSource = any, TArgs = any, TContext = any> = (rootValue?: TSource, args?: TArgs, context?: TContext, info?: any) => Promise<AsyncIterator<any>>;
...
export async function withFilterAsync<TSource = any, TArgs = any, TContext = any>(
    asyncIteratorFn: AsyncResolverFn<TSource, TArgs, TContext>,
    filterFn: FilterFn<TSource, TArgs, TContext>,
): Promise<AsyncResolverFn<TSource, TArgs, TContext>> {
